...
import { TelegaIcon, VkIcon, YouTubeIcon, PhoneFooterIcon } from "../../components/icons";
      ...
      <div className={Styles.footer__container}>
        <Container
          ...
          <ul className={Styles.footer__contacts}>
            ...
            <li className={Styles.footer__contacts_list}>
              <a href={"mailto:"+process.env.NEXT_PUBLIC_EMAIL} className={Styles.footer__contacts_phone}>
