      ...
      <div className={Styles.footer__container}>
        <Container
          ...
          <div className={Styles.footer__content}>
            <a href="/" className={Styles.footer__logo}><img src="/images/logo.svg" alt="logo" /></a>
            ...
            <div className={Styles.footer__social}>
              <Link href={"tel: +7 495 989-47-20"}><a className={Styles.footer__social_item}>
                <TelegaIcon />
              </a></Link>
              <Link href={"https://vk.com/veza_official"}>
              <a className={Styles.footer__social_item}>
                <VkIcon />
              </a></Link>
              <Link href={"https://www.youtube.com/channel/UCsNlnQ7uhAc_cOgHJPYMnRQ"}>
              <a className={Styles.footer__social_item}>
                <YouTubeIcon />
              </a></Link>
              <Link href={"tel: +7 495 989-47-20"}><a  className={Styles.footer__social_item}>
          ...
          <ul className={Styles.footer__contacts}>
            ...
            <li className={Styles.footer__contacts_list}>
              <a href="mailto: info@veza.ru" className={Styles.footer__contacts_phone}>
